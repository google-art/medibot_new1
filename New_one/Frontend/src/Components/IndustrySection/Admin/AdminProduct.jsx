...
//     {
//       name: "ClauseCraft",
//       desc: "Smart Contract Generator",
//       text:
//         "AI-powered contract generator with clause recommendations and smart editing.",
//       price: "$49",
//       icon: "📄",
//       status: "COMING_SOON",
//     },
//     {
//       name: "OnboardSecure",
//       desc: "AI Onboarding Assistant",
//       text:
//         "AI-driven onboarding assistant for KYC, AML, and compliance documentation.",
//       price: "$39",
//       icon: "🔐",
//       status: "COMING_SOON",
//     },
...
//             <div className="bg-cyan-400 text-black p-6 rounded-xl">⚖️</div>
...
//                 Simplify contracts, onboarding, and compliance documentation
//               </p>
...
//           AI Products for{" "}
//           <span className="text-cyan-500">Admin & Legal</span>
//         </h2>
//       </section>
...
//             Admin & Legal AI Tools Are Coming Soon
//           </h2>

//           <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-12">
//             We’re building powerful AI tools to simplify compliance, contracts,
  ...
  const products = [
    {
      ...
      icon: "📄",
      status: "COMING_SOON",
      detailsRoute: "/products/clausecraft",
    },
    {
      name: "OnboardSecure",
      desc: "AI Onboarding Assistant",
      ...
      icon: "🔐",
      status: "COMING_SOON",
      detailsRoute: "/products/onboardsecure",
    },
  ];
