...
//     {
//       name: "QR-AI Menu",
//       desc: "Smart Dynamic QR Menu",
//       text:
//         "A live AI-powered QR menu that updates daily and answers customer questions instantly.",
//       price: "$49",
//       icon: "📱",
//       status: "COMING_SOON",
//       route: null,
...
//     {
//       name: "AutoReserve",
//       desc: "AI Reservation & Booking Assistant",
//       text:
//         "AutoReserve manages table bookings across website and WhatsApp without human intervention.",
//       price: "$39",
//       icon: "📅",
//       status: "COMING_SOON",
//       route: null,
...
//     {
//       name: "OrderMind",
//       desc: "AI Order & Customer Insights",
//       text:
//         "Analyze customer ordering behavior and preferences to increase repeat visits and revenue.",
//       price: "$59",
//       icon: "📊",
//       status: "COMING_SOON",
//       route: null,
...
//                 Improve customer experience, reduce staff workload, and increase repeat visits
//               </p>
...
//           AI Products for{" "}
//           <span className="text-cyan-500">Restaurants</span>
//         </h2>
//       </section>
...
//                 p-8 flex flex-col md:flex-row justify-between gap-6 transition-all
...
//             Restaurant AI Tools Are Launching Soon
//           </h2>

//           <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-12">
//             We’re building AI tools specifically for restaurants to improve efficiency,
